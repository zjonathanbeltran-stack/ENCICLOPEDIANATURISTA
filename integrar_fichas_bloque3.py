"""
Integra fichas_bloque3.json en data/plantas.json.
Ejecutar desde: C:/Users/usuario/Desktop/proyecto/
"""
import json, sys
sys.stdout.reconfigure(encoding='utf-8')

fichas = json.load(open('fichas_bloque3.json', encoding='utf-8'))
...
for ficha in fichas:
    ...
    if pid not in idx:
        ...
        continue
    i = idx[pid]
    # Fusionar: preservar campos base, añadir/actualizar campos extendidos
